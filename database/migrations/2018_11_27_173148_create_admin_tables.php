...
class CreateAdminTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection($connection)->create(config('admin.database.page_table'), function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::connection($connection)->create(config('admin.database.button_table'), function (Blueprint $table) {
